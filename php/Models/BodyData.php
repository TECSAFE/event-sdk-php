...
final class BodyData implements \JsonSerializable
{
    /**
    ...
    public function __construct(
        private BodyDataPrimatyButton $primatyButton,
        private ?BodyDataSecondaryButton $secondaryButton,
    ) {
    }
    ...
    public static function from_json(string|array $json): self
    {
        ...
        return new self(
            isset($data['primatyButton']) ? BodyDataPrimatyButton::from_json($data['primatyButton']) : null,
            isset($data['secondaryButton']) ? BodyDataSecondaryButton::from_json($data['secondaryButton']) : null,
        );
    }
    ...
    {
        return [
          'primatyButton' => $this->primatyButton,
